require('dotenv').config(); // simpler form

// console.log('Is .env loaded?', process.env.FIREBASE_SERVICE_ACCOUNT !== undefined ? 'Yes' : 'No');
// console.log('Content of FIREBASE_SERVICE_ACCOUNT:', process.env.FIREBASE_SERVICE_ACCOUNT);
